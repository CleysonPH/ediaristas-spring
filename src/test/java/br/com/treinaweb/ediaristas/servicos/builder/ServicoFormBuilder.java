...
@Builder
public class ServicoFormBuilder {
    ...
    public ServicoForm buildServicoForm() {
        return new ServicoForm(nome, valorMinimo, qtdHoras, porcentagemComissao, horasQuarto, valorQuarto, horasSala,
